        ...
        <div className="space-y-12 w-full">
          ...
          <div className="prose lg:prose-xl">
            ...
            <p>
              ...
              sous le nom d'Oreonyx, dont le siège social est situé Office 25.3,
              25 Easton Street, London, WC1X 0DS, Angleterre, collectons et
              traitons vos données à caractère personnel et explique vos droits
              concernant vos données à caractère personnel. Si vous avez des
              questions sur la présente politique de confidentialité ou si vous
              souhaitez exercer l'un de vos droits relatifs à vos données
              personnelles, vous pouvez nous contacter à l'adresse ci-dessus ou
              par courrier électronique à l'adresse support@oreonyx.live. Notre
              méthode de contact préférée est le courrier électronique.
            </p>
            <p>
              ...
              la lire attentivement. Si vous n'acceptez pas d'être lié par cette
              politique de confidentialité, veuillez ne pas nous fournir vos
              données personnelles ou demander à votre employeur de ne pas le
              faire.
            </p>
            <p>
            ...
            <p>
              ...
              personnel par l'intermédiaire de notre plateforme parce que l'un
              de nos clients a téléchargé vos données dans son compte sur notre
              plateforme. Dans ce cas, nous sommes le responsable du traitement
              de vos données à caractère personnel et nous ne traiterons vos
              données à caractère personnel que conformément aux instructions du
              client.
            </p>
            <p>
              Dans certains cas, nous pouvons permettre à certains développeurs
              ou utilisateurs d'accéder à l'API d'Oreonyx afin de développer
              certaines applications permettant l'interopérabilité entre une
              plateforme tierce et les services d'Oreonyx (chacune étant une "
              application d'intégration "). Chaque application d'intégration
              ...
              vous pouvez partager en utilisant cette application d'intégration,
              et vous serez soumis aux conditions et à la politique de
              confidentialité distinctes de l'application d'intégration. Nous
              vous encourageons à lire les conditions et la politique de
              confidentialité de chaque application d'intégration que vous
              pouvez utiliser dans le cadre de nos services.
            </p>
            <p>
              Ce site web n'est pas destiné aux enfants et nous ne collectons
              pas sciemment des données relatives aux enfants.
            </p>
            <p>
              ...
              d'intégration). Le fait de cliquer sur ces liens ou d'activer ces
              connexions peut permettre à des tiers de collecter ou de partager
              des données vous concernant. Nous ne contrôlons pas ces sites web
              tiers et ne sommes pas responsables de leurs déclarations de
              confidentialité. Lorsque vous quittez notre site web, nous vous
              encourageons à lire la politique de confidentialité de chaque site
            ...
            <h4>
              ...
              notre plateforme. Nous nous réservons le droit d'anonymiser et/ou
              de pseudonymiser ces données personnelles afin qu'elles ne soient
              plus personnellement identifiables et de les utiliser sous une
              forme anonyme et/ou pseudonymisée à des fins commerciales
              internes, à des fins d'analyse ou à d'autres fins de temps à
              autre.
            </h4>
            <p>
            ...
            <p>
              ...
              par l'intermédiaire de nos plateformes de médias sociaux ou d'une
              application d'intégration, ou d'autres personnes peuvent fournir
              vos données personnelles, par exemple pour vous ajouter à l'espace
            ...
            <p>
              ...
              vous fournir des services, et nous vous l'indiquerons clairement
              au moment de la collecte des données à caractère personnel.
            </p>
            <p>
              Lorsque nous devons collecter des données à caractère personnel en
              vertu de la loi ou d'un contrat conclu avec vous et que vous ne
              nous fournissez pas ces données lorsque nous vous le demandons, il
              se peut que nous ne soyons pas en mesure d'exécuter le contrat que
              nous avons conclu ou que nous essayons de conclure avec vous (par
              exemple, pour vous fournir nos services). Dans ce cas, il se peut
              que nous devions annuler un produit ou un service que vous avez
              souscrit auprès de nous, mais nous vous en informerons à ce
              moment-là.
            </p>
            <p>
              ...
              soupçonnons ou identifions une fraude, nous l'enregistrerons et
              nous pourrons également le signaler. Lorsque vous nous contactez
              par courrier électronique ou postal, nous pouvons conserver une
              trace de la correspondance et nous pouvons également enregistrer
              tout appel téléphonique que nous avons avec vous.
            </p>
            ...
            <ul>
              <li>
                ...
                type d'appareil, le navigateur web ou le système d'exploitation
                ;
              </li>
              <li>
              ...
              <li>
                la durée d'utilisation du site web/de l'application et les
                services et fonctionnalités que vous avez utilisés.
              </li>
            </ul>
            <p>
              Certaines de ces informations sont collectées à l'aide de cookies
              et de technologies de suivi similaires. Si vous souhaitez en
              savoir plus sur les types de cookies que nous utilisons, pourquoi
              et comment vous pouvez les contrôler, veuillez consulter notre
            ...
            <p>
              ...
              tiers ou d'y accéder afin d'accéder à ces informations à partir de
              l'application Oreonyx et, dans ce cas, nous collecterons et
              stockerons automatiquement vos données d'utilisateur auprès de ce
              tiers. Ces données peuvent inclure
            </p>
            <ul>
            ...
            <p>
              ...
              concernant de la part d'une application d'intégration, de nos
              fournisseurs de paiement et/ou de nos partenaires de services de
              sécurité du site web, en particulier en cas d'utilisation abusive
              de la plateforme, y compris l'introduction de virus ou d'autres
            ...
            <h4>
              ...
              disposons d'une base légale pour le faire. Les motifs légitimes
              sur lesquels nous nous appuyons dans le cadre de la présente
              politique de protection de la vie privée sont les suivants :
            </h4>
            <ul>
              <li>
              ...
              <li>
                l'exécution de notre contrat avec vous, votre employeur ou votre
                collègue ;
              </li>
              ...
              <li>
                ...
                entreprise, qui n'ont pas d'impact matériel sur vos droits,
                votre liberté ou vos intérêts.
              </li>
            </ul>
            <p>
              Nous n'utiliserons vos données personnelles que si nous disposons
              d'une base légale pour le faire. La manière dont nous utilisons
              vos données personnelles dépend de la raison pour laquelle nous
              les avons collectées.
            </p>
            <p>
              3.1 Utilisation de données provenant de votre employeur ou d'un
              collègue qui utilise Oreonyx
            </p>
            <p>
              ...
              puissiez accéder aux applications Oreonyx et rejoindre l'espace de
              travail de votre employeur ou collègue.
            </p>
            <p>
            ...
            <p>
              ...
              d'améliorer l'expérience de gestion des courriels, des fichiers et
              des contacts et d'améliorer votre productivité lors de
              l'utilisation de l'application Oreonyx. En particulier, cela
              inclut l'accès à vos données d'utilisateur Google à partir de
              l'application Oreonyx où vous pouvez voir vos données dans le
              contexte pertinent d'une application de logiciel CRM et gérer vos
              relations professionnelles.
            </p>
            <p>
              Limites supplémentaires concernant l'utilisation de vos données
            ...
            <ul>
              <li>
                Nous n'utiliserons l'accès aux données d'un service Google
                connecté que pour fournir notre application web et mobile de CRM
                et de gestion des tâches Oreonyx qui permet aux utilisateurs de
                lire, traiter et écrire des e-mails, d'accéder à leurs fichiers
                Google Drive et à leur agenda. En outre, notre utilisation des
                données est limitée à la fourniture ou à l'amélioration des
                fonctionnalités destinées à l'utilisateur qui sont mises en
                évidence dans l'interface utilisateur de l'application qui en
                fait la demande.
              </li>
              <li>
              ...
              <li>
                Nous n'utiliserons jamais les données des utilisateurs de Google
                pour diffuser des publicités, y compris des publicités
                reciblées, personnalisées ou basées sur les centres d'intérêt.
              </li>
              <li>
                Nous n'autoriserons pas les êtres humains à lire ces données
                sauf si nous avons votre accord affirmatif pour des messages
                spécifiques, si cela est nécessaire à des fins de sécurité
                telles que l'investigation d'abus, pour se conformer à la loi
                applicable ou pour nos opérations internes et, même dans ce cas,
                uniquement lorsque les données ont été agrégées et rendues
                anonymes.
              </li>
              <li>
                ...
                API de Google, y compris les exigences relatives à l'utilisation
                limitée.
              </li>
            </ul>
            <p>
            ...
            <p>
              ...
              données personnelles pour l'un des objectifs légitimes décrits
              ci-dessus et selon vos instructions.
            </p>
            ...
            <p>
              ...
              contre le blanchiment d'argent et de prévention de la fraude), à
              des fins d'audit et pour vous contacter au sujet des modifications
            ...
            <p>
              ...
              techniques, d'utilisation et de profil pour nous faire une idée de
              ce que nous pensons que vous voulez ou avez besoin, ou de ce qui
              peut vous intéresser. C'est ainsi que nous décidons quels
              produits, services et offres peuvent être pertinents pour vous
            ...
            <p>
              ...
              suivant les liens d'exclusion figurant dans les messages marketing
              qui vous sont envoyés, en accédant aux paramètres de notre site
              web ou en nous contactant à tout moment.
            </p>
            <p>
              Si vous choisissez de ne plus recevoir ces messages marketing,
              cela ne s'appliquera pas aux données à caractère personnel qui
              nous sont fournies à la suite d'un achat, d'un enregistrement de
              garantie, d'une expérience avec un produit ou un service ou
              d'autres transactions. Il se peut donc que vous receviez des
              messages électroniques concernant votre utilisation, votre compte
              et/ou l'utilisation de votre compte par les utilisateurs, même si
              vous avez choisi de ne pas recevoir nos messages de marketing. En
              effet, ces courriels sont transactionnels et ne requièrent pas
              votre consentement pour être reçus. Veuillez noter que si vous
              refusez de recevoir des courriels de marketing, il se peut que
              nous ayons besoin de quelques jours pour mettre à jour nos
              dossiers afin de refléter votre demande.
            </p>
            <p>
              Si vous nous demandez de vous retirer de notre liste d'envoi de
              mises à jour de produits, nous conserverons votre nom et votre
              adresse électronique afin de nous assurer que nous ne vous
              enverrons plus d'informations sur les mises à jour de produits.
              Nous continuerons également à vous envoyer les informations
              nécessaires relatives à votre utilisation de nos services si vous,
              votre employeur ou votre collègue avez un compte chez nous.
            </p>
            <p>
            ...
            <p>
              ...
              analysons également les données relatives à l'utilisation de notre
              plateforme et utilisons ces informations pour améliorer nos
            ...
            <p>
              3.7 Utilisation des données pour traiter les demandes d'emploi
            </p>
            <p>
            ...
            <p>
              Nous n'utiliserons vos données à caractère personnel qu'aux fins
              pour lesquelles nous les avons collectées (telles que décrites
              ci-dessus), à moins que nous ne considérions raisonnablement que
              nous devons les utiliser pour une autre raison et que cette raison
              est compatible avec l'objectif initial. Si vous souhaitez obtenir
              une explication sur la manière dont le traitement pour la nouvelle
              finalité est compatible avec la finalité initiale, veuillez nous
              contacter.
            </p>
            <p>
            ...
            <p>
              ...
              aux règles susmentionnées, lorsque la loi l'exige ou le permet.
            </p>
            ...
            <p>
              ...
              pour nous fournir le service et, si nous cessons d'utiliser leurs
              services, nous leur demanderons de supprimer vos données à
            ...
            <p>
              ...
              d'argent ou pour protéger les droits, la propriété ou la sécurité
              d'un tiers.
            </p>
            <p>
            ...
            <h4>
              ...
              Royaume-Uni ou de l'EEE ou si l'un de nos fournisseurs de services
              est basé en dehors du Royaume-Uni ou de l'EEE.
            </h4>
            <p>
              Lorsque vos données personnelles sont transférées en dehors du
              Royaume-Uni ou de l'EEE, elles ne sont transférées qu'à des pays
              qui ont été identifiés comme offrant une protection adéquate de
              vos données ou à un tiers pour lequel nous avons mis en place des
              mécanismes de transfert approuvés pour protéger vos données
              personnelles, c'est-à-dire en concluant l'Accord international de
              transfert de données (IDTA) du Royaume-Uni ou un addendum, ou les
              Clauses contractuelles types de la Commission européenne.
            </p>
            <p>
              Veuillez nous contacter à l'adresse électronique indiquée dans la
              clause 10 si vous souhaitez obtenir de plus amples informations
              sur le mécanisme spécifique que nous utilisons lors du transfert
              de vos données à caractère personnel en dehors du Royaume-Uni ou
              de l'EEE en vertu du présent paragraphe.
            </p>
            <h4>6. Sécurité</h4>
            <p>
              Nous traiterons vos données à caractère personnel d'une manière
              qui garantisse une sécurité appropriée des données à caractère
              personnel, y compris la protection contre le traitement non
              autorisé ou illégal et contre la perte, la destruction ou les
            ...
            <p>
              Nonobstant ce qui précède, vous reconnaissez qu'aucun système ne
              peut être totalement sécurisé. Par conséquent, bien que nous
            ...
            <p>
              ...
              Certains de ces droits sont complexes et tous les détails n'ont
              pas été repris ci-dessous. De plus amples informations sont
              disponibles ici.
            </p>
            <ul>
              <li>
                Droit d'accès : Vous avez le droit d'obtenir de notre part une
                copie des données à caractère personnel que nous détenons à
                votre sujet.
              </li>
              <li>
              ...
              <li>
                ...
                circonstances, vous avez le droit d'exiger que nous limitions le
                traitement de vos informations personnelles.
              </li>
              <li>
                Droit à l'oubli : Vous avez également le droit d'exiger à tout
                moment que nous supprimions les données à caractère personnel
                que nous détenons à votre sujet, lorsqu'il n'est plus nécessaire
                que nous les conservions. Toutefois, bien que nous respections
                votre droit à l'oubli, nous pouvons conserver vos données à
                caractère personnel conformément aux lois applicables.
              </li>
              <li>
                Droit de ne plus recevoir d'informations commerciales : Vous
                pouvez nous demander de ne plus vous envoyer d'informations sur
                nos services, mais nous continuerons à vous contacter pour toute
                question relative à votre rapport.
              </li>
            </ul>
            <p>
              Vous n'aurez pas à payer de frais pour accéder à vos données
              personnelles (ou pour exercer l'un des autres droits). Toutefois,
              nous pouvons facturer des frais raisonnables si votre demande est
              manifestement infondée, répétitive ou excessive. Dans ce cas, nous
              pouvons également refuser de donner suite à votre demande.
            </p>
            <p>
              ...
              d'exercice de tout autre droit. Il s'agit d'une mesure de sécurité
              visant à garantir que les données à caractère personnel ne sont
              pas divulguées à une personne qui n'a pas le droit de les
              recevoir. Nous pouvons également vous contacter pour vous demander
              des informations complémentaires concernant votre demande afin de
              pouvoir la traiter rapidement.
            </p>
            <p>
              Nous nous efforçons de répondre à toutes les demandes légitimes
              dans un délai d'un mois. Il peut arriver que nous ayons besoin de
              plus d'un mois si votre demande est particulièrement complexe ou
              si vous avez formulé plusieurs demandes. Dans ce cas, nous vous en
              informerons et vous tiendrons au courant.
            </p>
            <p>
            ...
            <p>
              ...
              employé d'un client, nous les conserverons jusqu'à ce que nous ne
              travaillions plus avec votre employeur, sauf si nous sommes tenus
              de conserver les données personnelles pendant une période donnée
              pour nous conformer à des exigences légales, d'audit ou
              statutaires, y compris les exigences du HMRC en ce qui concerne
              les documents financiers.
            </p>
            <p>
              Si nous disposons de vos données personnelles parce qu'un client
              les a téléchargées sur notre plateforme, nous les conserverons
              conformément aux instructions de notre client.
            </p>
            <p>
            ...
            <p>
              ...
              personnelles anonymes (de sorte qu'elles ne puissent plus être
              associées à vous) à des fins de recherche ou de statistiques,
            ...
            <p>
              Si vous vous trouvez dans l'Union européenne, vous pouvez adresser
              vos questions relatives à la protection de la vie privée à notre
              représentant de l'UE conformément à l'article 27 du GDPR :
            </p>
