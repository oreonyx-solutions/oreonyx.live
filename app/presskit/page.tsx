          ...
          <div className="space-y-24">
            <div className="space-y-6">
              <div className="w-full md:w-8/12 space-y-3">
                ...
                <h4 className="text-lg">
                  Dans la mesure du possible, nous nous efforçons d'utiliser
                  notre logo principal en couleurs. Pour les fonds sombres,
                  veillez à utiliser notre logo primaire inversé.
                </h4>
              </div>
                ...
                <div className="space-y-4 w-full md:w-10/12 lg:w-6/12">
                  ...
                  <div>
                    ...
                    <h6 className="text-lg">
                      Il s'agit du logo principal de Oreonyx. Il devrait être
                      utilisé sous cette forme dans la mesure du possible.
                    </h6>
                  </div>
                </div>
                <div className="space-y-4 w-full md:w-10/12 lg:w-6/12">
        ...
        <div className="font-mono w-full md:w-8/12 space-y-10">
          <div className="space-y-3">
            ...
            <h5 className="text-lg">
              Il s'agit d'un rappel juridique amical que ces graphiques sont
              exclusifs et protégés par les lois sur la propriété
              intellectuelle.
            </h5>
          </div>
          <div className="space-y-3">
            ...
            <h5 className="text-lg">
              Prévoyez beaucoup d'espace autour du logo Oreonyx. Qu'ils soient
              grands ou petits, donnez-lui la possibilité de respirer et de ne
              pas se sentir encombré.
            </h5>
          </div>
          <div className="space-y-3">
            <h5 className="text-4xl font-medium">
            ...
            <ul className="text-lg list-disc pl-5">
              ...
              <li>
                Afficher ces graphiques d'une manière qui implique une relation,
                une affiliation ou une approbation par Oreonyx de votre produit,
                de votre service ou de votre entreprise.
              </li>
              <li>
              ...
              <li>
                Combiner ces graphiques avec d'autres graphiques sans l'accord
                écrit de Oreonyx.
              </li>
            </ul>
          </div>
