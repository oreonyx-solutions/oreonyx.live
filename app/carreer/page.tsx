      ...
      <div className="font-mono pt-24 space-y-12 px-4 md:px-6  xl:px-0 w-full md:max-w-6xl 2xl:max-w-7xl mx-auto">
        <div className="space-y-10">
          <div className="prose lg:prose-lg">
            ...
            <div>
              <h5>
                Chez Oreonyx, notre objectif est de révolutionner l'écosystème
                de l'éducation supérieure en fournissant une plateforme de
                gestion intégrée de nouvelle génération.
              </h5>
              <p>
                Nous sommes convaincus que les solutions actuelles sont
                obsolètes et qu'il est temps de repenser complètement la manière
                dont les établissements d'enseignement supérieur gèrent leurs
                processus administratifs et pédagogiques.
              </p>
              <p>
                Pour cela, nous mettons à disposition une solution innovante qui
                permet d'améliorer l'expérience étudiante et de faciliter la
                gestion administrative. Nous offrons des outils de collaboration
                et de formation à distance pour répondre aux besoins des
                établissements d'enseignement supérieur modernes.
              </p>
              <blockquote>
                ...
                <div className="w-full md:w-8/12 lg:w-full space-y-3 rounded-xl p-6 bg-gradient-to-tr from-black via-black to-green-300 text-white">
                  ...
                  <div className="pl-3">
                    <ul className="list-decimal">
                      ...
                      <li>
                        Travail à distance, pas d'obligation de déplacement vers
                        le bureau.
                      </li>
                      <li>
                      ...
                      <li>Evenements réguliers de l'équipe et hors-sites.</li>
